...
const Footer = () => {
  return (
    <footer className="bg-[#1a1c24] py-8 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center">
          <div className="flex items-center mb-6">
            <h2 className="text-2xl font-bold">
              <span className="text-white">Krishiv</span>
          ...
          <div className="flex space-x-6 mb-6">
            <a 
              ...
              className="bg-[#282c36] hover:bg-gray-700 p-3 rounded-full text-gray-300 hover:text-white transition-colors"
              aria-label="GitHub"
            >
              <Github size={20} />
            </a>
