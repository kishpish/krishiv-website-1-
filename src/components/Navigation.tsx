...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-navy/90 backdrop-blur-md z-50 border-b border-gray-800">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <div>
            <a href="/" className="text-xl font-bold text-white">KrishivPotluri</a>
          </div>
